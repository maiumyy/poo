...
const matematica = new Materia("Matemática", "Dr. Silva", "Segunda 14h", "#3498db");
console.log("Matéria criada:", matematica.toString());
const tarefa1 = new Tarefa(1, "Resolver exercícios de álgebra", matematica.nome, new Date("2023-11-20"), "alta");
...
lista.adicionarTarefa(new Tarefa(2, "Estudar para prova", "Física", new Date("2023-12-10"), "media"));
